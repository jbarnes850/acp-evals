        ...
        expected_steps=[
            {
                "step": "search",
                "tool": "web_search",
                "query_contains": ["quantum error correction", "algorithms", "2024"],
            },
            {
                "step": "filter",
                "action": "select_relevant_sources",
                "criteria": "technical papers, recent",
            },
            {
                "step": "extract",
                "action": "extract_key_information",
                "focus": ["algorithms", "error rates", "improvements"],
            },
            {
                "step": "synthesize",
                "action": "combine_information",
                "structure": "technical_summary",
            },
        ],
...
""",
        expected_steps=[
            {
                ...
                "issues": ["division_by_zero", "sort_mutation", "integer_division", "index_error"],
            },
            {
                "step": "fix",
                "tool": "code_editor",
            ...
            },
            {
                "step": "test",
                "tool": "code_executor",
                "test_cases": ["empty_list", "single_element", "even_length", "odd_length"],
            },
    ...
    AgentTask(
        ...
        expected_steps=[
            {"step": "parse", "action": "extract_data_points", "format": "time_series"},
            {
                "step": "calculate",
                "tool": "calculator",
                "metrics": ["growth_rate", "quarter_over_quarter", "year_over_year"],
            },
            {
                "step": "analyze",
                "tool": "statistical_analyzer",
                "analyses": ["trend", "seasonality", "forecast"],
            },
            {"step": "visualize", "tool": "chart_generator", "chart_types": ["line", "bar"]},
            {
                "step": "recommend",
                "action": "generate_insights",
                "focus": ["actionable", "data_driven"],
            },
        ],
    ...
    AgentTask(
        ...
        expected_steps=[
            ...
            {"step": "check", "tool": "support_ticket_system", "action": "find_previous_contacts"},
            {
                ...
                "options": ["replacement", "refund", "repair"],
            },
        ...
        difficulty="medium",
        metadata={"issue_count": 3, "customer_sentiment": "angry", "requires_de_escalation": True},
        failure_modes=[
            "dismissive_tone",
    ...
    AgentTask(
        ...
        expected_steps=[
            {
                ...
                "subtasks": ["market_size", "growth", "competitors", "regulations"],
            },
            {
                "step": "delegate",
            ...
            },
            {
                ...
                "ensure": "consistent_data_sources",
            },
            {
                "step": "review",
        ...
        difficulty="hard",
        metadata={"requires_coordination": True, "agent_count": 3, "handoff_points": 4},
        failure_modes=[
        ...
        expected_steps=[
            {
                "step": "research",
                "tool": "venue_finder",
                "filters": ["capacity>=200", "downtown_SF", "AV_equipped"],
            },
            {
                "step": "budget",
                "tool": "calculator",
                "breakdown": ["venue", "speakers", "catering", "equipment", "contingency"],
            },
            {
                "step": "search",
                "tool": "speaker_database",
                "criteria": ["technical_expertise", "availability", "budget_fit"],
            },
            {"step": "coordinate", "tool": "calendar", "action": "find_optimal_dates"},
            {
                "step": "plan",
                "tool": "project_planner",
                "deliverables": ["timeline", "task_list", "assignments"],
            },
            {
                "step": "validate",
                "action": "check_constraints",
                "verify": ["budget", "requirements", "preferences"],
            },
        ],
        expected_tools=[
            "venue_finder",
        ...
        expected_steps=[
            {
                ...
                "check": ["api_metrics", "db_metrics", "error_logs"],
            },
            {
                "step": "analyze",
                "tool": "log_analyzer",
            ...
            },
            {
                ...
                "hypothesis": ["db_bottleneck", "query_issue", "traffic_spike"],
            },
            {"step": "investigate", "tool": "database_profiler", "action": "identify_slow_queries"},
            {
                "step": "mitigate",
                "action": "apply_fix",
                "options": ["kill_slow_queries", "add_index", "scale_resources"],
            },
    ...
    AgentTask(
        ...
        difficulty="expert",
        metadata={"memory_analysis": True, "long_term_debugging": True, "requires_profiling": True},
        failure_modes=[
    ...
    AgentTask(
        ...
        expected_steps=[
            {
                "step": "identify",
                "tool": "distributed_tracer",
                "action": "map_transaction_dependencies",
            },
            {"step": "analyze", "tool": "lock_analyzer", "action": "detect_circular_dependencies"},
            {
                "step": "break",
                "action": "strategic_rollback",
                "priority": "least_impact_transactions",
            },
    ...
    AgentTask(
        ...
        expected_steps=[
            ...
            {"step": "trace", "tool": "lineage_tracker", "action": "map_corruption_to_sources"},
            {
                ...
                "action": "identify_corruption_patterns",
            },
            {
                "step": "isolate",
                "tool": "source_analyzer",
                "action": "narrow_down_problematic_sources",
            },
        ...
        difficulty="hard",
        metadata={"data_quality": True, "ml_impact": True, "subtle_corruption": True},
        failure_modes=[
    ...
    AgentTask(
        ...
        expected_steps=[
            ...
            {
                "step": "prioritize",
                "action": "triage_service_recovery",
                "order": "by_business_impact",
            },
...
PRODUCTION_CONSTRAINTS = {
    "latency_requirements": {"real_time": "< 100ms", "interactive": "< 1s", "batch": "< 1 minute"},
    "token_limits": {"small": 1000, "medium": 4000, "large": 16000},
    "rate_limits": {"api_calls_per_minute": 60, "tokens_per_minute": 90000},
    "reliability_targets": {"production": 0.99, "staging": 0.95, "development": 0.90},
}
