...
CORE_TASKS = [
    # Multi-step Information Synthesis (5 tasks)
    {
        ...
        "expected_evaluation": {
            "type": "semantic_llm",
            "criteria": {
                "identifies_recent_technologies": {
                    "weight": 0.3,
                    "description": "Lists current climate tech from 2024-2025",
                },
                "compares_effectiveness": {
                    "weight": 0.25,
                    "description": "Provides quantitative or qualitative comparison",
                },
                "includes_implementation_details": {
                    "weight": 0.25,
                    "description": "Realistic timelines and implementation steps",
                },
                "cites_specific_entities": {
                    "weight": 0.2,
                    "description": "Names companies, institutions, or research groups",
                },
            },
            "pass_threshold": 0.7,
        },
        ...
        "expected_evaluation": {
            ...
            "criteria": {
                "identifies_race_condition": {
                    "weight": 0.4,
                    "description": "Recognizes concurrent access issues with balance updates",
                },
                "proposes_locking_mechanism": {
                    "weight": 0.3,
                    "description": "Suggests database locks, transactions, or atomic operations",
                },
                "addresses_error_handling": {
                    "weight": 0.2,
                    "description": "Improves exception handling and rollback mechanisms",
                },
                "considers_scalability": {
                    "weight": 0.1,
                    "description": "Mentions performance impact of solutions",
                },
            },
            "pass_threshold": 0.75,
        },
    ...
    },
    {
        ...
        "expected_evaluation": {
            "type": "semantic_llm",
            "criteria": {
                "identifies_failure_points": {
                    "weight": 0.3,
                    "description": "Pinpoints likely causes: network issues, Spark failures, resource constraints",
                },
                "proposes_monitoring_solution": {
                    "weight": 0.25,
                    "description": "Suggests specific metrics, alerts, and SLAs",
                },
                "addresses_data_recovery": {
                    "weight": 0.25,
                    "description": "Backfill strategy and data validation",
                },
                "includes_preventive_measures": {
                    "weight": 0.2,
    ...
    },
    {
        ...
        "expected_evaluation": {
            "type": "semantic_llm",
            "criteria": {
                "recognizes_credential_stuffing": {
                    "weight": 0.3,
                    "description": "Identifies distributed credential stuffing attack",
                },
                "immediate_response_steps": {
                    "weight": 0.25,
                    "description": "Block suspicious IPs, force password resets, revoke tokens",
                },
                "investigation_methodology": {
                    "weight": 0.25,
                    "description": "Log analysis, user notification, breach assessment",
                },
                "long_term_hardening": {
                    "weight": 0.2,
                    "description": "MFA, advanced rate limiting, anomaly detection",
                },
            },
            "pass_threshold": 0.8,
        },
    ...
    },
    {
        ...
        "expected_evaluation": {
            "type": "semantic_llm",
            "criteria": {
                "acknowledges_urgency": {
                    "weight": 0.2,
                    "description": "Recognizes enterprise impact and CEO involvement",
                },
                "technical_diagnosis": {
                    "weight": 0.3,
                    "description": "Systematically addresses each technical issue",
                },
                "escalation_management": {
                    "weight": 0.25,
                    "description": "Involves engineering, provides executive updates",
                },
                "retention_strategy": {
                    "weight": 0.25,
                    "description": "Compensation, prevention plan, relationship repair",
                },
            },
            "pass_threshold": 0.75,
        },
