...
async def compare_patterns():
    ...
    from acp_evals.benchmarks.multi_agent import PatternComparison
...
@cli.command()
@click.argument('template', type=click.Choice(['simple', 'comprehensive', 'research', 'tool', 'acp-agent', 'multi-agent']), default='simple')
