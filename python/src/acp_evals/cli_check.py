...
from .config import check_provider_setup, get_provider_config
from .providers import ProviderFactory
from .exceptions import format_provider_setup_help

console = Console()


def check_env_file() -> Optional[Path]:
...
def check_providers(test_connection: bool, show_setup: Optional[str]):
    ...
    if env_path:
        console.print(f"✓ Found .env file at: {env_path}")
    else:
        console.print("✗ No .env file found in current or parent directories")
