    ...
    def test_generate_research_scenario(self):
        ...
        with open(output_file, 'r') as f:
            ...
            for line in lines:
                ...
                assert any(keyword in test_case['input'].lower() 
...
class TestTemplateQuality:
    ...
    def test_simple_template_execution(self):
        ...
        content = content.replace(
            'agent="your-agent-url-here"',
            'agent="mock-agent", mock_mode=True'
        )
...
class TestSyntheticDataQuality:
    ...
    def test_qa_data_quality(self):
        ...
        for i, test_case in enumerate(test_cases):
            ...
            has_question_word = any(word in input_text for word in 
    ...
    def test_research_data_complexity(self):
        ...
        for i, test_case in enumerate(test_cases):
            ...
            research_terms = ['analyze', 'research', 'investigate', 'study', 'examine', 
