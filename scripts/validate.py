...
def validate_imports():
    ...
    try:
        from acp_evals import AccuracyEval, PerformanceEval, ReliabilityEval, EvalResult
        from acp_evals import MetricResult, TokenUsage
