...
result = asyncio.run(eval.run(input="What is 2+2?", expected="4", print_results=True))
...
batch_result = asyncio.run(eval.run_batch(test_cases=test_cases, print_results=True))
