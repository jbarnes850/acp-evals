...
def smart_agent(input_text: str) -> str:
    ...
    if "capital" in input_lower and "france" in input_lower:
        return ("Paris is the capital of France. It's home to famous landmarks including "
    ...
    # Handle prime number questions
        ...
        return "Yes, 11 is a prime number because it has no positive divisors other than 1 and itself."
